        ...
        <div className='flex gap-3 sm:gap-4'>
          ...
          <div className='min-w-0 flex-1'>
            <div className='flex flex-col gap-4 md:flex-row md:items-stretch md:justify-between'>
              <div className='flex-1'>
                ...
                <div className='mb-3 flex flex-wrap gap-1.5 sm:gap-2'>
                  {(professional?.skills ?? []).map((skill, index) => (
                    <Badge
                      className='bg-gray-100 text-xs text-gray-600 hover:bg-gray-200 sm:text-sm'
                      key={index}
                    >
                      {skill}
                    </Badge>
              ...
              <div className='flex flex-row items-end justify-between gap-3 border-t border-gray-200 pt-3 md:flex-col md:justify-between md:border-t-0 md:pt-0 md:text-right'>
                <div className='flex flex-col gap-2 '>
                  ...
                  <p className='text-sm font-bold text-gray-800 sm:text-sm'>
