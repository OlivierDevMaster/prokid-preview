...
describe('Reports RLS - UPDATE', () => {
  ...
  it('should prevent unauthenticated users from updating reports', async () => {
    ...
    assertEquals(verifyData?.title, 'Test Report');
  });

  it('should allow professionals to update their own reports', async () => {
    const professional = await fixtureBuilder.createOnboardedProfessional();
    const structure = await fixtureBuilder.createOnboardedStructure();
    fixtures.push(professional, structure);
  ...
  it('should prevent professionals from updating reports they did not create', async () => {
  ...
  it('should allow admins to update any report', async () => {
    const professional = await fixtureBuilder.createOnboardedProfessional();
    const structure = await fixtureBuilder.createOnboardedStructure();
  ...
  it('should prevent structures from updating reports', async () => {
    const professional = await fixtureBuilder.createOnboardedProfessional();
    const structure = await fixtureBuilder.createOnboardedStructure();
    fixtures.push(professional, structure);
