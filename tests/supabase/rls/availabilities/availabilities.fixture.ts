...
export interface AvailabilityRlsFixture {
  adminClient: ReturnType<typeof createClient<Database>>;
...
export class AvailabilityRlsCleanupHelper {
  ...
  async cleanupAvailability(fixture: AvailabilityRlsFixture): Promise<void> {
    try {
...
export class AvailabilityRlsFixtureBuilder {
  ...
  async createOnboardedProfessional(): Promise<AvailabilityRlsFixture> {
  ...
  async createProfessionalWithAvailability(): Promise<AvailabilityRlsFixture> {
