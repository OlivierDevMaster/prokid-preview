...
describe('Availabilities RLS - SELECT', () => {
  ...
  it('should allow unauthenticated users to view all availabilities', async () => {
  ...
  it('should allow authenticated professionals to view all availabilities', async () => {
  ...
  it('should allow admins to view all availabilities', async () => {
    const professional = await fixtureBuilder.createOnboardedProfessional();
