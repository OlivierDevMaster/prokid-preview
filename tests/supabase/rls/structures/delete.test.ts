...
describe('Structures RLS - DELETE', () => {
  ...
  it('should prevent unauthenticated users from deleting structure profiles', async () => {
  ...
  it('should prevent authenticated users (non-structures) from deleting structure profiles', async () => {
    const structure = await fixtureBuilder.createOnboardedStructure();
  ...
  it('should allow structures to delete their own profile', async () => {
    const structure = await fixtureBuilder.createOnboardedStructure();
    fixtures.push(structure);
  ...
  it("should prevent structures from deleting other structures' profiles", async () => {
  ...
  it('should allow admins to delete any structure profile', async () => {
    const structure = await fixtureBuilder.createOnboardedStructure();
