...
/**
 * Server-side only helper pour appeler les Supabase Edge Functions
 * Ce fichier peut importer server.ts et next/headers
 */
...
/**
 * Appelle une Supabase Edge Function (server-side only)
 */
