export const reportBodyTemplateEn = `          <!-- Body content -->
          <tr>
            <td style="padding: 40px;">
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 25px; background-color: #f8f9fa; border-radius: 8px; overflow: hidden;">
                <tr>
                  <td style="padding: 20px; border-left: 4px solid #558cc9;">
                    <h2 style="margin: 0 0 15px 0; color: #2c3e50; font-size: 20px; font-weight: 600;">Professional Information</h2>
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="padding: 8px 0; color: #555; font-size: 14px;"><strong style="color: #2c3e50;">Name:</strong></td>
                ...
                <tr>
                  <td style="padding: 20px; border-left: 4px solid #82c4c1;">
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      ...
                      {{/mission_description}}
                      <tr>
                        <td style="padding: 8px 0; color: #555; font-size: 14px;"><strong style="color: #2c3e50;">Start Date:</strong></td>
                        <td style="padding: 8px 0; color: #333; font-size: 14px;">{{mission_start_date}}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #555; font-size: 14px;"><strong style="color: #2c3e50;">End Date:</strong></td>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 25px;">
                <tr>
                  <td>
                    <h2 style="margin: 0 0 15px 0; color: #2c3e50; font-size: 20px; font-weight: 600;">Report Content</h2>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 25px; background-color: #f8f9fa; border-radius: 8px; overflow: hidden;">
                <tr>
                  <td style="padding: 20px; border-left: 4px solid #82c4c1;">
                    <h3 style="margin: 0 0 15px 0; color: #2c3e50; font-size: 18px; font-weight: 600;">Attachments ({{attachments_count}})</h3>
