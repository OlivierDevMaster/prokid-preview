export const footerTemplateEn = `          <!-- Footer content -->
          <tr>
                ...
                <tr>
                  <td style="padding: 0; text-align: center;">
                    <p style="margin: 0 0 15px 0; color: #666; font-size: 12px; line-height: 1.6;">
                      <a href="[PRIVACY_POLICY_URL_PLACEHOLDER]" style="color: #558cc9; text-decoration: none; margin: 0 15px;">Privacy Policy</a>
                      <span style="color: #ccc;">|</span>
                      <a href="[CONTACT_URL_PLACEHOLDER]" style="color: #558cc9; text-decoration: none; margin: 0 15px;">Contact Us</a>
                    </p>
