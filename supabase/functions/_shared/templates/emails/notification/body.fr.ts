export const notificationBodyTemplateFr = `          <!-- Body content -->
          <tr>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-bottom: 25px; background-color: #f8f9fa; border-radius: 8px; overflow: hidden;">
                <tr>
                  <td style="padding: 20px; border-left: 4px solid #558cc9;">
                    <h3 style="margin: 0 0 15px 0; color: #2c3e50; font-size: 18px; font-weight: 600;">Détails</h3>
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      ...
                      {{#report_title}}
                      <tr>
                        <td style="padding: 8px 0; color: #555; font-size: 14px;"><strong style="color: #2c3e50;">Rapport:</strong></td>
                      ...
                      {{#professional_name}}
                      <tr>
                        <td style="padding: 8px 0; color: #555; font-size: 14px;"><strong style="color: #2c3e50;">Professionnel:</strong></td>
