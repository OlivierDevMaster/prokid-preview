...
-- ============================================================================
-- Function: create_mission_expired_notification
-- ============================================================================

CREATE OR REPLACE FUNCTION "public"."create_mission_expired_notification"()
RETURNS TRIGGER AS $$
DECLARE
  structure_name TEXT;
  professional_first_name TEXT;
  ...
  professional_name TEXT;
BEGIN
  -- Only create notification when status changes to expired
...
COMMENT ON FUNCTION "public"."create_mission_expired_notification"() IS 'Creates notifications for both professional and structure when a mission expires';

-- Trigger for mission expired
CREATE TRIGGER "trigger_create_mission_expired_notification"
  AFTER UPDATE OF "status" ON "public"."missions"
  FOR EACH ROW
