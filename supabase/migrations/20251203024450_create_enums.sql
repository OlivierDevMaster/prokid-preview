...
CREATE TYPE "public"."mission_status" AS ENUM ('pending', 'accepted', 'declined', 'cancelled', 'expired');

COMMENT ON TYPE "public"."mission_status" IS 'Status of missions: pending, accepted, declined, cancelled, or expired';
